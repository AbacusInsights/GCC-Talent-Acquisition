        ...
        <div className="relative bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="mt-3 mb-5">
            ...
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-slate-400 pointer-events-none" aria-hidden>
            ...
            {filtered.map((j) => (
              ...
              >
                <div className="flex items-center gap-4 min-w-0">
                  <div className={`${j.color} flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center font-semibold`}>
